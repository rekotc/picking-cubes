...
bool ModelClass::InitializeFlatRectangle(ID3D11Device* device, float width, float height, WCHAR* textureFilename)
{
	bool result;
...
bool ModelClass::InitializeBuffersFlatRectangle(ID3D11Device* device)
{
	...
	vertices[0].position = D3DXVECTOR3(-0.5f, -0.5f, 0.0f);  // Bottom left.
	vertices[0].texture = D3DXVECTOR2(0.0f, 1.0f);

	vertices[1].position = D3DXVECTOR3(-0.5f, 0.5f, 0.0f);  // Top left.
	vertices[1].texture = D3DXVECTOR2(0.0f, 0.0f);

	vertices[2].position = D3DXVECTOR3(0.5f, -0.5f, 0.0f);  // Bottom right.
	...
	vertices[3].position = D3DXVECTOR3(0.5f, 0.5f, 0.0f);  // Top right.
